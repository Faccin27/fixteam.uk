...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 overflow-hidden">
      <Navbar t={t} setT={setT} currentLanguage={currentLanguage} setCurrentLanguage={setCurrentLanguage} />
        ...
        <div className="container mx-auto px-4 z-10 pt-4 md:pt-0">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            >
              ...
              <p className="text-xl md:text-2xl mb-8 text-gray-300">{t.home.description}</p>
      ...
      <section id="services" className="py-20 bg-gray-800">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">{t.services.description}</p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-6">{t.about.description}</p>
              <p className="text-lg text-gray-400 mb-8">{t.about.additionalInfo}</p>
      ...
      <section className="py-20 bg-gray-800">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">{t.process.description}</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {t.process.steps.map((step: any, index: number) => (
              ...
              >
                ...
                <span className="text-5xl font-bold text-cyan-600/80 mb-4 block">{step.number}</span>
      ...
      <section className="py-20 bg-gray-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">{t.cta_section.title}</h2>
            <p className="text-xl text-gray-300 mb-8">{t.cta_section.description}</p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-gray-300 mb-8">{t.contact.form.formDescription}</p>
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="mt-8 pt-8 border-t border-gray-700">
                  <h4 className="font-bold text-lg mb-4">{t.contact.info.faq.title}</h4>
